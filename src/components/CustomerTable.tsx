...
export default function CustomerTable() {
	...
	const filteredCustomers = dataAppointment?.filter((c) => {
    const canView = currentUser?.role === "artist"
        ? c.idAr === currentUser?.artistId
        : true;
    ...
    return canView && matchesSearch && matchesDate;
});
